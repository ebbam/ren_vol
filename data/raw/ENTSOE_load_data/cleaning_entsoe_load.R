...
#### 2019-2024
for(yr in 2019:2024){
  temp <- read_xlsx(here(paste0("data/raw/ENTSOE_load_data/monthly_hourly_load_values_", yr, ".xlsx")))
...
#### 2006-2015
full_df <- read_xlsx(here("data/raw/ENTSOE_load_data/Monthly-hourly-load-values_2006-2015.xlsx"), skip = 3) %>% 
