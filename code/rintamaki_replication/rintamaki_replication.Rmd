...
The following is data from [ENTSO-E](https://www.entsoe.eu/data/power-stats/) on hourly electricity loads. Some of the country codes are inconsistent which explains some of the missing data for certain years. Will fix this. 

```{r, echo = FALSE, fig.height = 14}
entsoe %>% 
  ggplot(aes(x = date_utc, y = load)) +
  geom_line() +
  facet_wrap(~country_code, ncol = 4, scales = "free") + 
